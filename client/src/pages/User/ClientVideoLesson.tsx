    ...
    const handlePosterClick = async () => {
        ...
        if (videoLesson?.accessType === 'free' && id) {
            try {
                ...
                if (user._id) {
                    const duration = videoLesson?.duration || 100; // Используем длительность из данных или дефолтное значение
                            ...
                            return (
                                <div className="mt-6">
                                    <SecureKinescopePlayer
                                        ...
                                        poster={videoLesson?.imageUrl ? `${import.meta.env.VITE_API_URL}${videoLesson.imageUrl}` : undefined}
                        ...
                        return (
                            <div className="mt-6">
                                <div className="relative w-full rounded-lg overflow-hidden" style={{ paddingBottom: '56.25%' }}>
                                    {!showPoster && (
                                        <iframe
                                            src={getYouTubeEmbedUrl(videoLesson.videoUrl)}
